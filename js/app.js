console.log('Pickleball Signup v3.1 Visual Page Builder loaded');
...
function renderSiteEditor(){
  ...
  const cfg=editorSettings(), blocks=normalizeBlocks(cfg.customBlocks);
